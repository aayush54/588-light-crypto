...
std::string encrypt(const std::string& input, const std::string& associatedData,
...
std::string decrypt(const std::string& encrypted, const std::string& associatedData,
    const std::array<unsigned char, CRYPTO_NPUBBYTES>& nonce,
    const std::array<unsigned char, CRYPTO_KEYBYTES>& key
) {
...
int main() {
    ...
    auto encrypted = encrypt("hello", associatedData,nonce,key);
